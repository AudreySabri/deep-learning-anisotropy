...
def plot_mlp_predictions(results_dict, target_features, save_dir, filename="predictions.png"):
    ...
    pred_keys = sorted([k for k in results_dict.keys() if k.startswith("predictions_")])
